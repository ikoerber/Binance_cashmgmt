# Requirements Archive: v3.1 Hardening + Monitoring
...
- [x] **TELE-01**: TelegramNotifier Service sendet Nachricht bei Service-Ausfall (DOWN)
- [x] **TELE-02**: Graceful No-Op wenn TELEGRAM_BOT_TOKEN/CHAT_ID nicht konfiguriert
- [x] **TELE-03**: Alert-Routing trennt Health-Events von AlertBanner (keine AlertEventDB-Eintraege fuer Health)
...
| TELE-01 | Phase 20 | Complete |
| TELE-02 | Phase 20 | Complete |
